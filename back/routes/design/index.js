...
const { forkDesign2, forkDesign, getForkDesignList, getForkDesignTree, acceptForkDesign, denyForkDesign, kickoutForkDesign } = require("./forkDesign")
...
router.get("/explist/:page/:sort/:cate1/:keyword?", designList_newversion, getDesignList);
...
router.get("/forkDesignList/:id", getForkDesignList);
router.post("/forkdesign/accept/:id", auth, acceptForkDesign);
router.delete("/forkdesign/deny/:id", auth, denyForkDesign);
router.delete("/forkdesign/kickout/:id", auth, kickoutForkDesign);
