...
const { getMainMyGroupList, getMainMyDesignList, myPage, myAllDesign, myAllDesign2, myDesign, myGroup, inGroup, myLikeDesign, myLikeGroup, myLikeDesigner, getMyInvitedList, getMyInvitingList } = require("./myPage");
...
router.get("/myPage/bring-all-myDesign", auth, myAllDesign2, getDesignList);
