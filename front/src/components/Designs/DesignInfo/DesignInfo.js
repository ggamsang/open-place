...
import DesignMemberContainer from "containers/ExpItem/DesignMemberContainer";
import DesignComment from "components/Designs/GridEditor/DesignComment";
import { confirm } from "components/Commons/Confirm/Confirm";
import { alert } from "components/Commons/Alert/Alert";
import { YesIHaveReadNewComment } from "redux/modules/expitem";
...
class DesignInfo extends Component {
  ...
  moveDegisnForked = () => {
    ...
    if (this.props.new_design_id) {
      this.props.history.push("/expModify/" + this.props.new_design_id);
    }
  };
  ...
  goParentDesign = (parent) => {
    window.location.href = geturl() + `/exp/${parent}`;
  };
  getDesignComment() {
