...
class ModifyDesign extends Component {
  ...
  submit = () => {
    const data = {
      ...
      is_problem: this.state.is_problem ? 1 : 0,
    };
    if (
      data.files.length <= 0 ||
      data.files[0].value === this.props.DesignDetail.img.m_img
    ) {
      delete data.files;
    }
              ...
              <React.Fragment>
                <div className="board">
                  ...
                  <div className="board_label" style={{ marginTop: "22px" }}>
                    3. 디자인 설명<sub className="sub marginRight2">*</sub>
                  </div>
                  <div className="board_box">
                    <InputTextArea
                      id="explainBox"
            ...
            {/* <Section isNone={step === 1}>
              ...
              {step === 1 && (
                <div className="buttonWrap">
                  ...
                  <CustomButton onClick={this.gotoNextStep} isComplete={true}>
                    <BtnText>다음</BtnText>
                  </CustomButton>
                </div>
              )}
