...
export default class BoardDialog extends Component {
  ...
  write() {
    ...
    CreateGroupBoardRequest(
      { user_id: userInfo.uid, title: title, content: content },
      group_id,
      token
    )
      .then((res) => {
      ...
      <React.Fragment>
        {window.innerWidth < 500 ? (
          ...
          >
            ...
            <div className="title_mobile">게시판</div>
            <div
              className="flex"
                  ...
                  {list && list.length > 0 ? (
                    list.map((item, index) => (
                      <div
                        className="row"
                        key={index}
                        onClick={() => this.readBoard(item)}
                      >
                        <div className="num ellipsis">
                          {count - (page * per + index)}
                        </div>
              ...
              <NoticeWriteWrapper_mobile>
                ...
                <div>
                  <TextController
                    ...
                    userHeight="230"
                    item={{ content: "" }}
                    getValue={(data) => this.onChangeContent(data)}
                  />
                </div>
              </NoticeWriteWrapper_mobile>
            ) : null}
                  ...
                  {list && list.length > 0 ? (
                    list.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="create_time ellipsis">
                          {DateFormat(item.create_time)}
                        </div>
                      </div>
                    ))
