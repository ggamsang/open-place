...
class GroupListContainer_mobile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      count: 0,
      this_order:
        this.props.sort === "like"
          ? { text: "인기순", keyword: "like" }
  ...
  componentDidMount() {
    this.props
      ...
      .then(() => {
        this.props.GetGroupListRequest(0, null, null);
      });
  ...
  getList = async (page) => {
    ...
    return this.props
      ...
      .then(() => {
        this.props.GetGroupListRequest(page, sort, keyword);
      });
  };
      ...
      <Wrapper>
        <div className="contentBox">
          <div className="header_box">
            ...
            <OrderOptionMobile
              type="group"
              order_clicked={this.changeOrderOps}
              selected={this_order}
            />
          </div>
...
const mapDispatchToProps = (dispatch) => ({
  GetGroupListRequest: (page, sort, keyword) =>
    dispatch(GetGroupListRequest(page, sort, keyword)),
