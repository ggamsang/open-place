...
const MenuBox = styled.div`
  ...
  min-width: 100px;
  min-height: 1080px;
  background-color: ${window.location.pathname.indexOf("designer") != -1
    ? "#7E1E9B"
    : window.location.pathname.indexOf("Designer") != -1
    ? "#7E1E9B"
...
const MenuItem = styled.div`
  * {
  ...
  background-color: ${(props) =>
    props.isSelect == true ? "rgba(255,255,255,0.53)" : null};
  cursor: pointer;
  &:hover {
...
const BgColorSelector = () =>
  window.location.pathname.toLowerCase().indexOf("designer") != -1
    ? "#7E1E9B"
    : window.location.pathname.toLowerCase().indexOf("design") != -1
    ? "#1262AB"
    : window.location.pathname.toLowerCase().indexOf("group") != -1
    ? "#1E9B79"
    : window.location.pathname.toLowerCase().indexOf("/about") != -1
    ? "#39280b"
    : "red";
...
class Navigation extends Component {
  ...
  SignOut = () => {
    ...
    SetSession(TokenName, null).then((data) => {
        ...
        {mobile ? (
          <MobileMenuBox>
            ...
            <div className="menu_handle" onClick={this.props.onClickFolding}>
              ...
              <img
                className={`arrow ${
                  this.props.sidemenu ? "folding" : "notfolding"
                }`}
                ...
                <div className="alarm-message-icon-wrapper">
                  <div className="alarm-icon-wrapper">
                    {this.state.alarm.count > 0 ? (
                      <div className="alarm-count">
                        <p>
                          {this.state.alarm.count > 99
                            ? 99
                            : this.state.alarm.count}
                        </p>
                      </div>
                    ) : null}
                  ...
                  <div className="message-icon-wrapper">
                    {this.state.alarm.countMsg > 0 ? (
                      <div className="message-count">
                        <p>
                          {this.state.alarm.countMsg > 99
                            ? 99
                            : this.state.alarm.countMsg}
                        </p>
                      </div>
                    ) : null}
            ...
            {ismainmenu == NOT ? (
              <React.Fragment>
                <a className="link_tag" href="/">
                  <MenuItem className="menu_tag marginTop1">메인메뉴</MenuItem>
                </a>
                  ...
                  <React.Fragment>
                    ...
                    {loc[3] ? (
                      <React.Fragment>
                        <a
                          className="link_tag"
                          href={`/design/update/${loc[3]}`}
                        >
                          <MenuItem
                            isSelect={!loc[4]}
                            className="menu_tag marginTop1 border-bottom"
                          >
                            {this.props.category1.find(
                              (item) => item.value == loc[3]
                            ) &&
                              this.props.category1.find(
                                (item) => item.value == loc[3]
                              ).text}
                        ...
                        {this.props.category2 &&
                          ...
                          this.props.category2[loc[3] - 1].map(
                            (item, index) => (
                              <a
                                key={index}
                                className="link_tag"
                                href={`/design/update/${loc[3]}/${item.value}`}
                              >
                                <MenuItem
                ...
                {loc[1] === "group" ? (
                  <a className="link_tag" href="/group">
                    <MenuItem
                      isSelect={
                        (window.location.pathname == "/group") == true
                          ? true
                          : false
                      }
                    ...
                    {loc[3] ? (
                          ...
                          this.props.category2[loc[3] - 1].map(
                            (item, index) => (
                              <a
                                key={index}
                                className="link_tag"
                                href={`/designer/update/${loc[3]}/${item.value}`}
                              >
                                <MenuItem
                                  isSelect={loc[4] === `${item.value}`}
                                  className="menu_tag submenu"
                      ...
                      this.props.category1.map((item, index) => (
                        <a
                          key={index}
                          className="link_tag"
                          href={`/designer/update/${item.value}`}
                        >
                          <MenuItem
                            isSelect={loc[3] === `${item.value}`}
                            className="menu_tag submenu "
              ...
              <React.Fragment>
                <a className="link_tag" href="/design">
                  <MenuItem
                    isSelect={
                      (window.location.pathname == "/design") == true
                        ? true
                        : false
                    }
                    className="menu_tag marginTop1"
                ...
                <a className="link_tag" href="/designer">
                  <MenuItem
                    isSelect={
                      (window.location.pathname == "/designer") == true
                        ? true
                        : false
                    }
                    className="menu_tag marginTop1"
            ...
            {this.props.userInfo == null ? null : (
              <a className="link_tag" onClick={this.SignOut}>
                <MenuItem className="stickToEnd menu_tag border-top">
                  로그아웃
                </MenuItem>
              </a>
            )}
          ...
          <MenuBox h={this.state.h} id="menubox">
            ...
            <div className="menu_handle" onClick={this.props.onClickFolding}>
              <img
                className={`arrow ${
                  this.props.sidemenu == true ? "folding" : "notfolding"
                }`}
                src={new_logo_handle_arrow}
              />
            </div>
            ...
            <MenuItem
              isSelect={
                (window.location.pathname == "/") == true ? true : false
              }
              className="menu_tag marginTop1"
            >
              <a className="link_tag" href="/">
            ...
            <MenuItem
              isSelect={
                ...
                window.location.pathname.search("/design/") > -1
                  ? true
                  : false || window.location.pathname.search("/exp/") > -1
                  ? true
                  : false ||
                    window.location.pathname.search("/createDesign") > -1
                  ? true
                  : false ||
                    window.location.pathname.search("/modifyDesign/") > -1
                  ? true
                  : false
              }
              className="menu_tag marginTop1"
            ...
            <MenuItem
              isSelect={
                ...
                window.location.pathname.search("/group/") > -1
                  ? true
                  : false ||
                    (window.location.pathname.search("/groupDetail/") > -1
                      ? true
                      : false) ||
                    window.location.pathname.search("/createGroup") > -1
                  ? true
                  : false ||
                    window.location.pathname.search("/modifyGroup/") > -1
                  ? true
                  : false
              }
              className="menu_tag marginTop1"
            ...
            <MenuItem
              isSelect={
                ...
                window.location.pathname.search("/designer/") > -1
                  ? true
                  : false ||
                    (window.location.pathname.search("/designerDetail/") > -1
                      ? true
                      : false) ||
                    (window.location.pathname.search("/designerdetail/") > -1
                      ? true
                      : false) ||
                    window.location.pathname.search("/createDesigner") > -1
                  ? true
                  : false ||
                    window.location.pathname.search("/modifyDesigner/") > -1
                  ? true
                  : false
              }
              className="menu_tag marginTop1"
            ...
            <MenuItem
              isSelect={
                window.location.pathname.search("/about") > -1 ? true : false
              }
              className="menu_tag marginTop1"
            >
              <a className="link_tag" href="/aboutIntro">
            ...
            {this.props.userInfo == null ? null : (
              <MenuItem className="menu_tag marginTop1" onClick={this.SignOut}>
                로그아웃
              </MenuItem>
            )}
