...
import star from "resources/mobiles/Iconly-Bold-Star-red.svg";
import heart from "resources/mobiles/Iconly-Bold-Heart-white.svg";
...
class ExpDetail extends React.Component {
  ...
  render() {
    ...
    // create_time:      "2023-08-02T13:08:59.000Z"
    // d_flag:      0
    // design_type:      3
    // explanation:      null
    // img:      {s_img: 'https://s3.ap-northeast-2.amazonaws.com/osd.uploads.com/place/thumbnails/1690949339832-x50.png', m_img: 'https://s3.ap-northeast-2.amazonaws.com/osd.uploads.com/place/thumbnails/1690949339832-x200.png', l_img: 'https://s3.ap-northeast-2.amazonaws.com/osd.uploads.com/place/thumbnails/1690949339832-x600.png'}
    // is_commercial:      0
    ...
    // title:      "ssssss"
    // uid:      5618
    // update_time:      "2023-08-23T12:45:21.000Z"
    // userName:      "ggam2"
    // user_id:      1949
    // waitingStatus:      0
    // wires:      null
          ...
          >
            <div className="content">
              ...
              <div className="buttonWrap2">
                {this.props.userInfo?.uid === expDetail?.user_id && (
                  <ButtonNormal
