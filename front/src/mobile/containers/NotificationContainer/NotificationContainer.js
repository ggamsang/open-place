...
import notification from "resources/mobiles/Iconly-alarm-white.svg";
...
class NotificationContainer extends React.Component {
  ...
  activateNotification = () => {
    console.log("activate notification", this.props.userInfo);
    ...
    this.socket = io("https://place.opensrcdesign.com")
      ...
      .on("getNoti", (alarm) => {
        this.setState({ notification: alarm || [] });
      });
  ...
  onClicked = (id) => {
    this.NotificationIReadRequest(id).then(this.onOpen);
  };
  ...
  render() {
    ...
    return (
      <React.Fragment>
        {/* <div id='dimmer'> &nbsp; </div> */}
        <NotificationBox onClick={this.onOpen} className="notification_box">
        ...
        {this.state.active ? (
          <NotificationModal
            ...
            close={this.onClose}
            list={this.state.notification?.list}
          />
        ) : null}
      </React.Fragment>
    );
