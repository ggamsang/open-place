...
const AUTH_SIGNIN_IS_NOT_MEMBER =
  "opendesign/authentication/AUTH_SIGNIN_IS_NOT_MEMBER";
const AUTH_SIGNIN_IS_NOT_PASSWORD =
  "opendesign/authentication/AUTH_SIGNIN_IS_NOT_PASSWORD";
...
const AUTH_CHECK_TOKEN_SUCCESS =
  "opendesign/authentication/AUTH_CHECK_TOKEN_SUCCESS";
const AUTH_CHECK_TOKEN_FAILURE = "AUTH_CHECK_TOKEN_FAILURE";
const AUTH_CHECK_EMAIL = "opendesign/authentication/AUTH_CHECK_EMAIL";
const AUTH_CHECK_EMAIL_SUCCESS =
  "opendesign/authentication/AUTH_CHECK_EMAIL_SUCCESS";
const AUTH_CHECK_EMAIL_FAILURE =
  "opendesign/authentication/AUTH_CHECK_EMAIL_FAILURE";
const AUTH_CHECK_NICKNAME = "opendesign/authentication/AUTH_CHECK_NICKNAME";
const AUTH_CHECK_NICKNAME_SUCCESS =
  "opendesign/authentication/AUTH_CHECK_NICKNAME_SUCCESS";
const AUTH_CHECK_NICKNAME_FAILURE =
  "opendesign/authentication/AUTH_CHECK_NICKNAME_FAILURE";
...
const SignInIsNotMember = () => ({
  type: AUTH_SIGNIN_IS_NOT_MEMBER,
  success: false,
});
const SignInIsNotPassword = () => ({
...
const GetDevNoticeFailure = (error) => ({
  type: GET_DEV_NOTICE_FAILURE,
  error,
});
...
export function CheckNickNameRequest(NickName) {
  return (dispatch) => {
    ...
    return fetch(`${host}/users/checkNickName`, {
      headers: { "Content-Type": "application/json" },
      method: "POST",
