...
const GetMyMainGroupList = (data) => ({
  type: GET_MY_MAIN_GROUP_LIST,
  MyMainGroup: data,
});
const MyMainGroupListClear = (data) => ({
  type: MY_MAIN_GROUP_LIST_CLEAR,
  MyMainGroup: data,
  MyMainGroupAdded: [],
});
const MyMainGroupListFail = () => ({
  type: MY_MAIN_GROUP_LIST_FAIL,
  MyMainGroup: [],
  MyMainGroupAdded: [],
});

const GetMyMainDesignList = (data) => ({
  type: GET_MY_MAIN_DESIGN_LIST,
  MyMainDesign: data,
});
const MyMainDesignListClear = (data) => ({
  type: MY_MAIN_DESIGN_LIST_CLEAR,
  MyMainDesign: data,
  MyMainDesignAdded: [],
});
const MyMainDesignListFail = () => ({
  type: MY_MAIN_DESIGN_LIST_FAIL,
  MyMainDesign: [],
  MyMainDesignAdded: [],
});
...
const MyDesignListClear = (data) => ({
  type: GET_MY_DESIGN_CLEAR,
  MyDesign: data,
  MyDesignAdded: [],
});
const MyDesignListFail = () => ({
  type: MY_DESIGN_FAIL,
  MyDesign: [],
  MyDesignAdded: [],
});
const GetMyGroupList = (data) => ({ type: GET_MY_GROUP, MyGroup: data });
const MyGroupListClear = (data) => ({
  type: GET_MY_GROUP_CLEAR,
  MyGroup: data,
  MyGroupAdded: [],
});
const MyGroupListFail = () => ({
  type: MY_GROUP_FAIL,
  MyGroup: [],
  MyGroupAdded: [],
});

const GetMyLikeDesign = (data) => ({
  type: GET_MY_LIKE_DESIGN,
  MyLikeDesign: data,
});
const MyLikeDesignClear = (data) => ({
  type: GET_MY_LIKE_DESIGN_CLEAR,
  MyLikeDesign: data,
  MyLikeDesignAdded: [],
});
const MyLikeDesignFail = () => ({
  type: MY_LIKE_DESIGN_FAIL,
  MyLikeDesign: [],
  MyLikeDesignAdded: [],
});

const GetMyLikeGroup = (data) => ({
  type: GET_MY_LIKE_GROUP,
  MyLikeGroup: data,
});
const MyLikeGroupClear = (data) => ({
  type: GET_MY_LIKE_GROUP_CLEAR,
  MyLikeGroup: data,
  MyLikeGroupAdded: [],
});
const MyLikeGroupFail = () => ({
  type: MY_LIKE_GROUP_FAIL,
  MyLikeGroup: [],
  MyLikeGroupAdded: [],
});

const GetMyLikeDesigner = (data) => ({
  type: GET_MY_LIKE_DESIGNER,
  MyLikeDesigner: data,
});
const MyLikeDesignerClear = (data) => ({
  type: GET_MY_LIKE_DESIGNER_CLEAR,
  MyLikeDesigner: data,
  MyLikeDesigneRAdded: [],
});
const MyLikeDesignerFail = () => ({
  type: MY_LIKE_DESIGNER_FAIL,
  MyLikeDesigner: [],
  MyLikeDesigneRAdded: [],
});
const GetMyInvitedList = () => ({ type: GET_MY_INVITED_LIST });
const GetMyInvitedListSuccess = (data) => ({
  type: GET_MY_INVITED_LIST_SUCCESS,
  list: data,
});
const GetMyInvitedListFailure = () => ({
  type: GET_MY_INVITED_LIST_FAILURE,
  list: [],
});
const GetMyInvitingList = () => ({ type: GET_MY_INVITING_LIST });
const GetMyInvitingListSuccess = (data) => ({
  type: GET_MY_INVITING_LIST_SUCCESS,
  list: data,
});
const InsertUserDetail = () => ({ type: INSERT_USER_DETAIL });
const InsertUserDetailSuccess = (res) => ({
  type: INSERT_USER_DETAIL_SUCCESS,
  res,
});
...
const UpdateUserDetailFailure = () => ({
  type: UPDATE_USER_DETAIL_FAILURE,
  success: false,
});
const GetMyInvitingListFailure = () => ({
  type: GET_MY_INVITING_LIST_FAILURE,
  list: [],
});
...
export function InsertUserDetailRequest(data, token) {
  return (dispatch) => {
    ...
    return fetch(`${host}/users/insertDetail_newversion`, {
  ...
  return (dispatch) => {
    ...
    return fetch(url, {
      ...
      .then((data) => {
        dispatch(
          page === 0
            ? MyMainDesignListClear(data || [])
            : GetMyMainDesignList(data || [])
        );
      })
      .catch((error) => {
        console.error("err:", error);
  ...
  return (dispatch) => {
    ...
    return fetch(url, {
      ...
      .then((data) => {
        dispatch(
          page === 0
            ? MyMainGroupListClear(data || [])
            : GetMyMainGroupList(data || [])
        );
      })
      .catch((error) => {
        console.error("err:", error);
