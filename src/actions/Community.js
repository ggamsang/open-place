...
const ModifyArticleSuccess = () => ({ type: types.MODIFY_ARTICLE_SUCCESS, result:"success" });
const ModifyArticleFailure = () => ({ type: types.MODIFY_ARTICLE_FAILURE, result:"failure" });
