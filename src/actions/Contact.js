...
const CreateExpContactFailure = (err) => ({ type: types.CREATE_CONTACT_FAILURE, error: err, });
// R
...
const GetExpContactListSuccess = (data) => ({ type: types.GET_CONTACT_LIST_SUCCESS, contacts: data.detail });
const GetExpContactListFailure = (err) => ({ type: types.GET_CONTACT_LIST_FAILURE, error: err, contacts: [] });
// U
...
const UpdateExpContactFailure = (err) => ({ type: types.UPDATE_CONTACT_FAILURE, error: err });
// D
...
const DeleteExpContactFailure = (err) => ({ type: types.DELETE_CONTACT_FAILURE, error: err, });
...
const GetExpContactSuccess = (data) => ({ type: types.GET_CONTACT_SUCCESS, detail: data.detail });
const GetExpContactFailure = (err) => ({ type: types.GET_CONTACT_FAILURE, error: err, detail: null });