...
const CreateExpReviewFailure = (err) => ({ type: types.CREATE_REVIEW_FAILURE, error: err, });
// R
...
const UpdateExpReviewFailure = (err) => ({ type: types.UPDATE_REVIEW_FAILURE, error: err });
// D
