...
const Wrap = styled.div`
  ...
  .clear {
    ...
    position: absolute;
    z-index: 10;
    top: ${(props) => (props.height - 16) / 2}px;
    right: 5px;
...
const InputField = styled.input`
  ...
  display: flex;
  align-items: center;
  font-size: ${(props) => (props.fontSize === null ? "17" : props.fontSize)}px;
  color: ${(props) => (props.fontColor === null ? "black" : props.fontColor)};
  padding-left: ${(props) =>
    props.paddingLeft === null ? "10" : props.paddingLeft}px;
  outline: none;
  border: none;
  border-bottom: 2px solid
    ${(props) => (props.bgColor === null ? "black" : props.bgColor)};
  ::placeholder {
    color: #999999;
  }
`;
      ...
      <React.Fragment>
        <Wrap warning={warning} height={this.props.height}>
          <InputField
            ...
            warning={warning}
          />
          <div onClick={this.props.onClear} className="clear">
            X
          </div>
        </Wrap>
      </React.Fragment>
