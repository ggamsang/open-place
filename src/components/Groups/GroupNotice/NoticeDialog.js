...
import {
  GetTotalCountGroupNoticeRequest,
  GetGroupNoticeListRequest,
...
d      pagination
  ...
  write() {
    ...
    CreateGroupNoticeRequest(token, {
      group_id: group_id,
      title: title,
      content: content,
    })
      ...
      <React.Fragment>
        {window.innerWidth < 500 ? (
          <NoticeModalWrapper_mobile
            loseOnDimmerClick={mode === WRITE ? false : true}
            open={open}
            onClose={() => close()}
          >
