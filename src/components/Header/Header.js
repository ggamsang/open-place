              ...
              <div className="wrap">
                <div className="menu_nav">
                  ...
                  {this.props.userInfo != null ? (
                    <a href="/myPage">
                      <Profile
                        img={
                          this.props.userInfo.thumbnail &&
                          this.props.userInfo.thumbnail.s_img
                        }
                      />
                    </a>
                  ) : (
                ...
                <a href="/">
                  <img
                    src={
                      window.location.pathname.indexOf("designer") != -1
                        ? `${new_logo_opendesign_purple}`
                        : window.location.pathname.indexOf("Designer") != -1
                        ? `${new_logo_opendesign_purple}`
                        : window.location.pathname.indexOf("design") != -1
                        ? `${new_logo_opendesign_blue}`
                        : window.location.pathname.indexOf("Design") != -1
                        ? `${new_logo_opendesign_blue}`
                        : window.location.pathname.indexOf("group") != -1
                        ? `${new_logo_opendesign_green}`
                        : window.location.pathname.indexOf("Group") != -1
                        ? `${new_logo_opendesign_green}`
                        : `${new_logo_opendesign}`
                    }
