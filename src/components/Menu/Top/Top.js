...
const Wrapper = styled.div`
   ...
   *{
    ...
    .signup-button {
        ...
        width: 156px;
        height: 42px;
        background: transparent linear-gradient( 110deg, #F8F8F8 0%, #FF0000 100%) 0% 0% no-repeat padding-box;
    ...
    .create-button {
        ...
        width: 156px;
        height: 42px;
        background: transparent linear-gradient(110deg, #F8F8F8 0%, #001DFF 100%) 0% 0% no-repeat padding-box;
        box-shadow: 1px 1px 3px #00000029;
        border-radius: 30px 0px;
        opacity: 1;
        p {
...
class Bottom extends React.Component {
    ...
    render() {
        ...
        return (<Wrapper>
            ...
            <div>
                <button className='make-button' onClick={() => goto("MAKE", "1/null")}>
                    <p>만들기</p>
                </button>
                <button className='learn-button' onClick={() => goto("LEARN", "1/null")}>
                    <p>배우기</p>
                </button>
                <button className='play-button' onClick={() => goto("PLAY", "1/null")}>
                    <p>모여서놀기</p>
                </button>
                ...
                {login
                    ...
                    <div className='signup' onClick={() => goto("MYDETAIL")}>
                        ...
                        <button className="create-button"
                            onClick={() => goto("CREATE-ITEM")}><p>등록</p></button>
