...
import CounselingMessageDetailContainer from "desktop/containers/CounselingMessageDetailContainer";
import { ExpTypes } from "constant";
import PlayGameContainer from "desktop/containers/PlayGameContainer/PlayGameContainer";
import ContactContainer from "desktop/containers/ContactContainer";
import { goto } from "navigator";
import expimg from "resources/Listimg.png";
import staricon from "resources/star.svg";
import firstpage from "resources/firstpage.svg";
...
import NumRate from "../ExpDetail/NumRate";
...
const ExpInnerDiv = styled.div`
  display: inline-block;
  margin-left: 34px;
  margin-top: 33px;
`;

const NameAndTagsDiv = styled.div`
  display: flex;
  // margin-top: 23px;
  align-items: center;
`;
...
class Buy extends React.Component {
  ...
  onClickBuy = (event) => {
    ...
    this.props
      .buy(this.props.token, this.props.expDetail.uid)
      .then((data) => data.json())
      .then((data) => {
        console.log(data);
        if (data.success) {
