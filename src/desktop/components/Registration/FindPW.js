...
import Logo from "desktop/components/Commons/Logo";
import styled from "styled-components";
import { resolution } from "desktop/commons/resolution";
import GradientButton from "desktop/components/Commons/Button/GradientButton";

import InputLine from "desktop/components/Commons/Input/InputLine";
import InputPhone from "desktop/components/Commons/Input/InputPhone";
import ImageButton from "desktop/components/Commons/Button/ImageButton";
// import InputEmail from "desktop/components/Commons/Input/InputEmail";
        ...
        <Wrapper>
          <Fade when={this.state.page1}>
            <div
              className="content"
              style={{
                display: `${this.state.page1 === false ? "none" : "block"}`,
              }}
            >
              ...
              <div
                style={{ height: "50vh" }}
                className="box column alignCenter justifyCenter"
              >
                <GradientButton
                  onClickEvent={() => {
          ...
          <Fade when={this.state.page2_1}>
            <div
              className="content"
              style={{
                display: `${this.state.page2_1 === false ? "none" : "block"}`,
              }}
            >
              <div className="box alignCenter justifyCenter">
                <Logo
              ...
              <div className="box column alignCenter">
                ...
                <div
                  style={{ height: "40vh" }}
                  className="buttonWrap justifyCenter"
                >
                  <GradientButton
                    onClickEvent={this.verifyMeWithPhone}
                    text="본인인증하기"
                    width={292}
                    height={52}
                    front={"#FF4343"}
          ...
          <Fade when={this.state.page2_2}>
            <div
              className="content"
              style={{
                display: `${this.state.page2_2 === false ? "none" : "block"}`,
              }}
            >
              <div className="box alignCenter justifyCenter">
                <Logo
              ...
              >
                <GradientButton
                  onClickEvent={this.passwordResetRequest}
                  text="이메일로 보내기"
                  width={292}
                  height={52}
                  front={"#FF4343"}
          ...
          <Fade when={this.state.page3}>
            <div
              className="content"
              style={{
                display: `${this.state.page3 === false ? "none" : "block"}`,
              }}
            >
              <div className="box alignCenter justifyCenter">
                <Logo
              ...
              <div className="result_text">{this.state.message}</div>
              <div
                className="buttonWrap justifyCenter"
                style={{ height: "40vh" }}
              >
