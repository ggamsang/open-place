...
import CheckBoxNormal from "desktop/components/Commons/CheckBox/CheckBoxNormal";
      ...
      <React.Fragment>
        <Wrapper>
          ...
          <Fade when={this.state.page1}>
            <div
              className="box column alignCenter"
              style={{
                display: `${this.state.page1 === false ? "none" : "flex"}`,
              }}
            >
              <div className="inputBox">
                ...
                <InputLine
                  onChangeValue={this.onChangeFirstName}
                  placeholder="이름"
                ...
                <InputLine
                  onChangeValue={this.onChangeLastName}
                  placeholder="성"
          ...
          <Fade when={this.state.page2}>
            <div
              className="box column alignCenter"
              style={{
                display: `${this.state.page2 === false ? "none" : "flex"}`,
              }}
            >
