...
class ModifySharer extends React.Component {
  ...
  onSubmit = async () => {
    ...
    console.log(data);
    // return;
    await this.props.updateSharerProfileRequest(this.props.userInfo.uid, data, this.props.token)
    goto("MYDETAIL");
...
// import SearchForm from 'components_desktop/commons/Search/SearchForm';
// import SharerForm from './SharerForm';

// import ButtonNormal from 'components_desktop/commons/Button/\bButtonNormal';
// import { WIDTH } from 'constant';
