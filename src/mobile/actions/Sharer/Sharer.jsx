...
import { GET, DELETE, POST } from "src/constants";
...
const getSharerSuccess = (data) => ({
  type: types.GET_SHARER_DETAIL_SUCCESS,
  sharer: data.data,
});
const getSharerFailure = (err) => ({
  type: types.GET_SHARER_DETAIL_FAILURE,
  sharer: null,
  err: err,
});
