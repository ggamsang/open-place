...
import arrowBelow from "src/imgs/icons-chevron@2x.png";
...
class CommentList extends React.Component {
  ...
  write = (parent) => {
    ...
    if (node) {
      if (node.value !== "") {
        this.props
          .CreateArticleCommentRequest(token, {
            ...
            <div key={idx} className="line comment-list-wrapper">
              ...
              <div className="row hundred">
                ...
                <div className="arrowDown">
                  <img
                    onClick={() =>
                      this.popup(whichOnePoppedUp === null ? idx : null)
                    }
              ...
              {isReply === item.uid && <CommentForm parent={item.uid} />}
            </div>
          ))
        ) : (
          <div>&nbsp;</div>
