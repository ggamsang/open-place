...
class CounselingMessageDetail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      nowlist: [],
      more:
        this.props.chats && this.props.chats.length > this.per ? false : true,
      text: "",
      file: null,
    };
  ...
  onFileSelected = async (e) => {
    ...
    /* 
        ...
        */
    const fileurl =
      "https://s3.ap-northeast-2.amazonaws.com/osd.uploads.com/dev/uploads/e6126d7ff264cab0f25484f1d9f1588d";
    this.setFile({ file: fileurl }, () => {
        ...
        <MessageWrapper url={(header && header.url) || profile} online={online}>
          ...
          <div className="chats" id="chats">
            {nowlist.map((item, index) => (
              <Fade key={index}>
                <Chat {...item} me={item.user_id === user_id} />
              </Fade>
            ))}
          </div>
