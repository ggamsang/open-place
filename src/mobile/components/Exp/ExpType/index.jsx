...
class ExpType extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.content !== this.props.content) {
      ...
      this.setState({
        exp_files: this.props.exp_files ? [].concat(this.props.exp_files) : [],
      });
    }
  ...
  render() {
    ...
    return (
      <Wrapper>
          ...
          {type === TYPE_TALK && (
            <React.Fragment>
              ...
              <div className="row">
                ...
                <InputNormal
                  onChangeValue={this.onChangePlace}
            ...
            <React.Fragment>
              ...
              <div className="row">
                <div className="label wide">
                  1) index.html만 업로드
                  <br />
                  2) 폴더로 업로드, 파일 내 index.html이 반드시 있어야 함.
                  <br />
                </div>
              </div>
            </React.Fragment>
        ...
        <div className="whiteBox">
          <InputFile
            files={this.state.exp_files}
            display={true}
            getValue={(value) => this.onChangeFile(value)}
            accept=""
          />
        </div>
      </Wrapper>
