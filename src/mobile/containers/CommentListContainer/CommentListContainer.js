...
import CommentList from "mobile/components_mobile/CommentList";
...
const mapDispatchToProps = (dispatch) => ({
    GetArticleCommentRequest: (id) =>
        dispatch(GetArticleCommentRequest(id)),
    CreateArticleCommentRequest: (token, form) =>
        dispatch(CreateArticleCommentRequest(token, form))
});

export default
    connect(mapStateToProps, mapDispatchToProps)(CommentListContainer);
