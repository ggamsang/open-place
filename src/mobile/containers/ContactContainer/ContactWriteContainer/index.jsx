...
import {
  CreateExpContactRequest,
  GetExpContactListRequest,
...
class ContactWriteContainer extends React.Component {
  submit = (data) =>
    this.props.CreateExpContactRequest(this.props.token, data).then((data) => {
      if (data.success) {
...
const mapDispatchToProps = (dispatch) => ({
  ...
  CreateExpContactRequest: (token, data) =>
    dispatch(CreateExpContactRequest(token, data)),
});
