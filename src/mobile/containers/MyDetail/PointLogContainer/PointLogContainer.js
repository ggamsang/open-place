...
import PointLogList from "mobile/components_mobile/PointLogList";
import {
  GetPointListRequest,
...
const mapDispatchToProps = (dispatch) => ({
  GetPointListRequest: (page, token) => dispatch(GetPointListRequest(page, token)),
  GetTotalPointCountRequest: (token) => dispatch(GetTotalPointCountRequest(token)),
});
