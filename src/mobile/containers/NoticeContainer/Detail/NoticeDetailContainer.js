...
import NoticeDetail from 'mobile/components_mobile/Notice/Detail';
...
class NoticeDetailContainer extends React.Component {
  ...
  GetDetail = (id) =>
    this.props.GetNoticeDetailRequest(id)
...
export default
  connect(mapStateToProps, mapDispatchToProps)(NoticeDetailContainer);
