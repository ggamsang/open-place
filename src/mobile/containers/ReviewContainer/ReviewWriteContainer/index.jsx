...
class ReviewWriteContainer extends React.Component {
  submit = (data) =>
    this.props.CreateExpReviewRequest(this.props.token, data).then((data) => {
      if (data.success) {
...
const mapDispatchToProps = (dispatch) => ({
  ...
  CreateExpReviewRequest: (token, data) =>
    dispatch(CreateExpReviewRequest(token, data)),
});
