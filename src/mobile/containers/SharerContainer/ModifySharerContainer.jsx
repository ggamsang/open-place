...
import ModifySharer from "../../components/Sharer/ModifySharer";
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    deleteSharerRequest: (token, user_id) => {
      dispatch(deleteSharerRequest(token, user_id));
    },
  };
};
